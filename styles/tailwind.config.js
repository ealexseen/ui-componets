...
var BORDER_RADIUS = '6px';
var BORDER_COLOR = '#E8E9EC';
module.exports = {
  theme: {
    screens: {
      sm: '640px',
    ...
    borderColor: function borderColor(theme) {
      return (0, _extends2["default"])({}, theme('colors'), {
    ...
    boxShadow: function boxShadow(theme) {
      return {
        ...
        'primary': "0 0 0 2px ".concat(theme('colors.blue.100')),
        'danger': "0 0 0 2px ".concat(theme('colors.red.100')),
        'success': "0 0 0 2px ".concat(theme('colors.green.100')),
        'none': 'none'
      };
    },
    fontFamily: {
